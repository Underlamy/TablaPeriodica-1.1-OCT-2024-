...
define("ROOTURL", "http://localhost/tablaPeriodica/community/");
define("HOMEURL", "http://localhost/tablaPeriodica/");
...
define("DOCROOT", $_SERVER["DOCUMENT_ROOT"].'/tablaPeriodica/community/');
...
define("HEADERCOMMUNITY", DOCROOT."header.php");
define("FOOTERCOMMUNITY", DOCROOT."footer.php");
